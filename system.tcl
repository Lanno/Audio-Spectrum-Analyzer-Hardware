...
proc create_root_design { parentCell } {
  ...
  set audio_bclk [ create_bd_port -dir I audio_bclk ]
  set audio_rx [ create_bd_port -dir I audio_rx ]
  set audio_rx_ws [ create_bd_port -dir I audio_rx_ws ]
  set audio_tx [ create_bd_port -dir O audio_tx ]
  set audio_tx_ws [ create_bd_port -dir I audio_tx_ws ]
  ...
  set logii2s [ create_bd_cell -type ip -vlnv logicbricks.com:logicbricks:logii2s:2.3 logii2s ]
  set_property -dict [ list \
   CONFIG.C_I2S_0_CLOCKMASTER {0} \
   CONFIG.C_I2S_0_DIRECTION {1} \
   CONFIG.C_I2S_0_WSMASTER {0} \
   CONFIG.C_I2S_1_CLOCKEDGE {0} \
   CONFIG.C_I2S_1_CLOCKMASTER {0} \
   CONFIG.C_I2S_1_DIRECTION {0} \
   CONFIG.C_I2S_1_WSMASTER {0} \
   CONFIG.C_NUM_OF_I2S {2} \
 ] $logii2s
 ...
 ] [get_bd_intf_pins /logii2s/s_axi]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins mute/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins logii2s/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins leds/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net i2s_0_bclk_in_0_1 [get_bd_ports audio_bclk] [get_bd_pins logii2s/i2s_0_bclk_in] [get_bd_pins logii2s/i2s_1_bclk_in]
  connect_bd_net -net i2s_0_ws_in_0_1 [get_bd_ports audio_tx_ws] [get_bd_pins logii2s/i2s_0_ws_in]
  connect_bd_net -net i2s_1_s_in_1 [get_bd_ports audio_rx] [get_bd_pins logii2s/i2s_1_s_in]
  connect_bd_net -net i2s_1_ws_in_0_1 [get_bd_ports audio_rx_ws] [get_bd_pins logii2s/i2s_1_ws_in]
  connect_bd_net -net logii2s_i2s_0_s_out [get_bd_ports audio_tx] [get_bd_pins logii2s/i2s_0_s_out]
  connect_bd_net -net logii2s_interrupt [get_bd_pins logii2s/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins buttons/s_axi_aclk] [get_bd_pins leds/s_axi_aclk] [get_bd_pins logii2s/s_axi_aclk] [get_bd_pins mute/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins switches/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn1 [get_bd_pins buttons/s_axi_aresetn] [get_bd_pins leds/s_axi_aresetn] [get_bd_pins logii2s/s_axi_aresetn] [get_bd_pins mute/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins switches/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs logii2s/s_axi/reg0] SEG_logii2s_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mute/S_AXI/Reg] SEG_mute_Reg
