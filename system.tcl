...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set i2s_0_bclk_out [ create_bd_port -dir O i2s_0_bclk_out ]
  set i2s_0_s_out [ create_bd_port -dir O i2s_0_s_out ]
  set i2s_0_ws_out [ create_bd_port -dir O i2s_0_ws_out ]
  set i2s_1_s_in [ create_bd_port -dir I i2s_1_s_in ]
  set i2s_1_ws_out [ create_bd_port -dir O i2s_1_ws_out ]
  set tx_clk_0 [ create_bd_port -dir O tx_clk_0 ]
...
CONFIG.C_I2S_1_CLOCKMASTER {1} \
CONFIG.C_I2S_1_WSMASTER {1} \
...
CONFIG.GPIO_BOARD_INTERFACE {sws_4bits} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins logii2s/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins mute/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
